...
import {
  ...
  Boxes, Map, LayoutTemplate, Activity, GitBranch, TrendingUp, Wind, Bot, Shield, FileText,
} from 'lucide-react'
...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      { id: 'system-architecture', label: 'System Architecture', icon: Boxes },
      { id: 'navigation-model', label: 'Navigation Model', icon: Map },
      { id: 'patterns', label: 'Patterns', icon: LayoutTemplate },
      { id: 'states', label: 'States', icon: Activity },
      { id: 'decision-rules', label: 'Decision Rules', icon: GitBranch },
      { id: 'metrics-system', label: 'Metrics System', icon: TrendingUp },
      { id: 'motion', label: 'Motion', icon: Wind },
      { id: 'ai-layer', label: 'AI Layer', icon: Bot },
